:- module(time_interval,
    [ interval_constraint/2,
      ...
      interval_query/1,
      interval_equals/2,        %-> soma:simultaneous,
      interval_before/2,        %-> soma:before,
      interval_after/2,         %-> soma:after,
      interval_meets/2,         %-> soma:meets,
      interval_met_by/2,        %-> soma:metBy,
      interval_starts/2,        %-> soma:starts,
      interval_started_by/2,    %-> soma:startedBy,
      interval_finishes/2,      %-> soma:finishes,
      interval_finished_by/2,   %-> soma:finishedBy,
      interval_overlaps/2,      %-> soma:overlappedOn,
      interval_overlapped_by/2, %-> soma:overlappedBy,
      interval_during/2         %-> soma:during
    ]).
